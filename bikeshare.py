...
error_message_3="Sorry the value you entered is invalid, please try again using the following days (monday, tuesday, wednesday, thursday, friday, saturday, sunday, all)"
